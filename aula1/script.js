...
function moeda(type) {
    ...
    if (type == 'USD>BRL') {
        ...
        conversao = conversao.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' });
        ...
        let conversao = n / 5.51;
        conversao = conversao.toLocaleString('en', { style: 'currency', currency: 'USD' });

        input = input.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' });
